...
impl DescriptorId {
    ...
    pub fn characteristic(&self) -> CharacteristicId {
        let index = self.object_path.rfind('/').expect("DescriptorId object_path must contain a slash.");
...
mod tests {
    ...
    fn descriptor_characteristic() {
        ...
        let descriptor_id = DescriptorId::new("/org/bluez/hci0/dev_11_22_33_44_55_66/service0022/char0033/desc0034");
