...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgFreedesktopNetworkManagerVPNPlugin for blocking::Proxy<'a, C> {
...
impl arg::ReadAll for OrgFreedesktopNetworkManagerVPNPluginStateChanged {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopNetworkManagerVPNPluginStateChanged {
            state: i.read()?,
        })
    }
}
...
impl arg::ReadAll for OrgFreedesktopNetworkManagerVPNPluginConfig {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopNetworkManagerVPNPluginConfig {
            config: i.read()?,
        })
    }
}
...
impl arg::ReadAll for OrgFreedesktopNetworkManagerVPNPluginLoginBanner {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopNetworkManagerVPNPluginLoginBanner {
            banner: i.read()?,
        })
    }
}
...
impl arg::ReadAll for OrgFreedesktopNetworkManagerVPNPluginFailure {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopNetworkManagerVPNPluginFailure {
            reason: i.read()?,
        })
    }
}
