...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgFreedesktopNetworkManagerDeviceIPTunnel for blocking::Proxy<'a, C> {
...
impl arg::ReadAll for OrgFreedesktopNetworkManagerDeviceIPTunnelPropertiesChanged {
    fn read(i: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopNetworkManagerDeviceIPTunnelPropertiesChanged {
            properties: i.read()?,
        })
    }
}
